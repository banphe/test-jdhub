/**
 * Mock danych kalendarza - pokoje, klienci, rezerwacje.
 * Generuje testowe dane do development bez Firebase.
 */

/**
 * Generuje listę pokoi.
 */
export function generateMockRooms() {
  return [
    { id: 'room-1', name: 'Duży' },
    { id: 'room-2', name: 'Mały' }
  ];
...
/**
 * Generuje listę rezerwacji na dzisiaj.
 */
